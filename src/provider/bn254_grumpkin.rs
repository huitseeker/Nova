...
use ::grumpkin::bn256::{
  self, Affine as Bn256G1Affine, Compressed as Bn256G1Compressed, Point as Bn256G1,
};
use ::grumpkin::grumpkin::{
  self, G1Affine as GrumpkinG1Affine, G1Compressed as GrumpkinG1Compressed, G1 as GrumpkinG1,
};
