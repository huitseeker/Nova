  ...
  C2: StepCircuit<E2::Scalar>,
{
  ...
  #[serde(with = "BigArray")]
  pub circuit_shapes: [CircuitShape<E1>; N],
  ...
  C2: StepCircuit<E2::Scalar>,
{
  ...
  pub fn setup<NC: NonUniformCircuit<E1, E2, C1, C2, N>>(
    ...
    let circuit_shapes: [CircuitShape<E1>; N] = (0..N)
      .map(|i| {
  ...
  pub fn into_parts(self) -> ([CircuitShape<E1>; N], AuxParams<E1, E2>) {
  ...
  pub fn from_parts(circuit_shapes: [CircuitShape<E1>; N], aux_params: AuxParams<E1, E2>) -> Self {
    let pp = PublicParams {
      circuit_shapes,
  ...
  pub fn from_parts_unchecked(
    circuit_shapes: [CircuitShape<E1>; N],
